      ...
      return (
        <div className="flex items-center justify-center min-h-screen p-8 bg-[#0A0A0A]">
          <div className="flex flex-col items-center w-full max-w-2xl p-8">
            ...
            <div className="p-4 w-full rounded bg-[#141414] border border-[#333] overflow-auto mb-6">
              <pre className="text-sm text-[#888] whitespace-pre-wrap">
            ...
            <button
              ...
              className={cn(
                ...
                "bg-[#2bb673] text-[#0A0A0A] font-medium",
                "hover:bg-[#25a065] cursor-pointer"
              )}
            >
              <RotateCcw size={16} />
              Reload Page
